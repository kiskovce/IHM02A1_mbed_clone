...
OBJECTS += ./L6470_functions.o
OBJECTS += ./X_NUCLEO_IHM02A1/BSP/XNucleoIHM02A1.o
OBJECTS += ./X_NUCLEO_IHM02A1/Components/L6470/L6470.o
OBJECTS += ./functions.o
OBJECTS += ./main.o
...
OBJECTS += ./mbed-os/features/cellular/framework/device/ATHandler.o
...
OBJECTS += ./mbed-os/features/cellular/framework/targets/TELIT/ME910/TELIT_ME910_CellularNetwork.o
...
OBJECTS += ./mbed-os/features/cellular/framework/targets/UBLOX/N2XX/UBLOX_N2XX_CellularNetwork.o
...
OBJECTS += ./mbed-os/features/mbedtls/targets/TARGET_STM/TARGET_STM32L4/aes_alt.o
...
OBJECTS += ./mbed-os/features/netsocket/CellularNonIPSocket.o
...
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32L4/device/stm32l4xx_hal_exti.o
...
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32L4/device/stm32l4xx_hal_mmc.o
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32L4/device/stm32l4xx_hal_mmc_ex.o
...
OBJECTS += ./serial_function.o
OBJECTS += ./variables.o


INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/BSP
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/Components
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/Components/Common
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/Components/L6470
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/ST_INTERFACES
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/ST_INTERFACES/Actuators
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/ST_INTERFACES/Common
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/ST_INTERFACES/Communications
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/ST_INTERFACES/Sensors
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/X_NUCLEO_COMMON
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/X_NUCLEO_COMMON/DbgMCU
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/X_NUCLEO_COMMON/DevI2C
INCLUDE_PATHS += -I.././X_NUCLEO_IHM02A1/X_NUCLEO_COMMON/DevSPI
...
INCLUDE_PATHS += -I../C:/Users/kravcikm/eclipse-workspace/Final_IHM02A1_my/mbed-os
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1583500989.6
...
C_FLAGS += -DTARGET_NAME=NUCLEO_L432KC
C_FLAGS += -DTARGET_STM
...
C_FLAGS += -DMBED_RAM_SIZE=0xc000
C_FLAGS += -DMBED_RAM1_START=0x10000000
C_FLAGS += -DMBED_RAM1_SIZE=0x4000
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1583500989.6
...
CXX_FLAGS += -DTARGET_NAME=NUCLEO_L432KC
...
ASM_FLAGS += -I..
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\BSP
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\Components
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\Components\Common
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\Components\L6470
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\ST_INTERFACES
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\ST_INTERFACES\Actuators
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\ST_INTERFACES\Common
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\ST_INTERFACES\Communications
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\ST_INTERFACES\Sensors
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\X_NUCLEO_COMMON
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\X_NUCLEO_COMMON\DbgMCU
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\X_NUCLEO_COMMON\DevI2C
ASM_FLAGS += -I..\X_NUCLEO_IHM02A1\X_NUCLEO_COMMON\DevSPI
ASM_FLAGS += -I..\mbed-os
...
ASM_FLAGS += -I..\mbed-os\features\mbedtls\targets\TARGET_STM\TARGET_STM32L4
ASM_FLAGS += -I..\mbed-os\features\nanostack
...
ASM_FLAGS += -I..\mbed-os\features\netsocket
ASM_FLAGS += -I..\mbed-os\features\netsocket\emac-drivers\TARGET_STM
ASM_FLAGS += -I..\mbed-os\features\netsocket\ppp
...
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32L4
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32L4\TARGET_STM32L432xC
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32L4\TARGET_STM32L432xC\TARGET_NUCLEO_L432KC
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32L4\TARGET_STM32L432xC\device
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32L4\device
ASM_FLAGS += -IC:\Users\kravcikm\eclipse-workspace\Final_IHM02A1_my\mbed-os
ASM_FLAGS += -include
